pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://34.207.169.155:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: 'https://github.com/2300033507/fullstackapp.git', branch: 'master'
            }
        }
    ...
    post {
        success {
            echo "✅ Backend deployed: http://34.207.169.155:9090/springapp1"
            echo "✅ Frontend deployed: http://34.207.169.155:9090/frontapp1"
        }
        failure {
